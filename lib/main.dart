import 'package:adminside/app_module/presentation/category/categorylist.dart';
...
import 'package:adminside/app_module/presentation/user/user.dart';
            ...
            children: [
              ...
              GestureDetector(
                onTap: () =>
                    ...
                    Get.to(() => CategoryList(
                          isactuallyinoffer: 'i',
                          streamallthing: //  FirebaseFirestore.instance
